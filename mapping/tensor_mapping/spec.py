"""兼容层：旧的 ``tensor_mapping.spec`` 导入路径。

实现已迁到 ``llm_infer_model.tensor.spec``（见
...
from llm_infer_model.tensor.spec import *  # noqa: F401,F403
from llm_infer_model.tensor.spec import __all__  # noqa: F401
